...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "भारत पहचान" },
      { property: "og:title", content: "भारत पहचान — डिजिटल चुनाव अभियान एजेंसी" },
      {
        property: "og:description",
        content: "वेबसाइट, सोशल मीडिया, व्हाट्सएप अभियान और वीडियो प्रोडक्शन।",
      },
