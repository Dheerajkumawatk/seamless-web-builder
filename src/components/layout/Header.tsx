    ...
    <>
      <header className="sticky top-0 z-50 shadow-[0_2px_12px_rgba(18,58,114,.18)]">
        ...
        <div className="border-b border-[#dde5f0] bg-white/98 backdrop-blur">
          <div className="mx-auto grid h-[76px] max-w-[1720px] grid-cols-[minmax(0,1fr)_auto] items-center gap-4 px-4 md:h-[104px] md:px-8 lg:flex lg:justify-between xl:px-14">
            <Link
              href="/"
