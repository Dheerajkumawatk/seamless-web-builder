...
export const stats = [
  { value: "500+", label: "अभियान क्रिएटिव्स" },
  { value: "50+", label: "वेबसाइट तैयार" },
  { value: "20+", label: "राज्यों में सेवा" },
  { value: "100+", label: "उम्मीदवारों का भरोसा" },
];
...
export const services = [
  {
    ...
    short: "प्रोफेशनल वेबसाइट जो आपकी पहचान और विज़न को दर्शाए",
    points: [
      "मोबाइल फ्रेंडली रिस्पॉन्सिव डिज़ाइन",
      "उम्मीदवार परिचय और विकास योजना सेक्शन",
      "गैलरी, वीडियो और न्यूज़ अपडेट",
  ...
  },
  {
    ...
    short: "फेसबुक, इंस्टाग्राम, ट्विटर, यूट्यूब सभी प्लेटफ़ॉर्म पर मज़बूत उपस्थिति",
    points: [
      "पेज सेटअप और ऑप्टिमाइज़ेशन",
      "रोज़ाना पोस्टिंग कैलेंडर",
      "पेड ऐड कैंपेन",
  ...
  },
  {
    ...
    short: "डेटा एनालिटिक्स और परफ़ॉर्मेंस रिपोर्ट ताकि रणनीति और बेहतर हो",
    points: [
      "रीच और एंगेजमेंट रिपोर्ट",
      "क्षेत्रवार परफ़ॉर्मेंस",
...
export const process = [
  ...
  { num: "03", icon: PenTool, title: "ब्रांडिंग और डिज़ाइन" },
  { num: "04", icon: Rocket, title: "वेबसाइट और सेटअप" },
...
export const packages = [
  {
    name: "स्टार्टर पैकेज",
    desc: "शुरुआत करें मज़बूत डिजिटल पहचान के साथ",
    price: "₹9,999",
    period: "/माह",
    featured: false,
    features: [
...
export const testimonials = [
  {
    quote:
      "भारत पहचान टीम ने हमारी पूरी डिजिटल पहचान को एक नई ऊँचाई दी। वेबसाइट, सोशल मीडिया और व्हाट्सएप अभियान बहुत प्रभावी रहा।",
    name: "मोहनलाल जी",
    role: "सरपंच, राजस्थान",
  },
  {
    quote:
      "बहुत ही प्रोफेशनल टीम है, समय पर काम पूरा करते हैं और हर समय सपोर्ट में रहते हैं।",
    name: "सीता देवी",
    role: "पंचायत समिति सदस्य, मध्य प्रदेश",
  },
  {
    quote:
      "हमारे जिला परिषद चुनाव में डिजिटल अभियान ने बहुत बड़ा योगदान दिया।",
    name: "अजय सिंह",
...
export const portfolio = [
  ...
  { title: "पंचायत समिति अभियान — मध्य प्रदेश", type: "व्हाट्सएप + क्रिएटिव्स", image: "panchayat" },
...
export const blogPosts = [
  {
    ...
    title: "पंचायत चुनाव में डिजिटल रणनीति क्यों ज़रूरी है?",
    excerpt:
      "आज गाँव-गाँव में स्मार्टफोन है। जानिए कैसे डिजिटल अभियान आपके प्रचार को हर मतदाता तक पहुँचा सकता है।",
    date: "12 अगस्त 2026",
    category: "रणनीति",
    image: "village",
  },
  {
    ...
    excerpt:
      "बूथ-वार ग्रुप, कार्यकर्ता नेटवर्क और ब्रॉडकास्ट — एक व्यवहारिक गाइड।",
    date: "02 अगस्त 2026",
    category: "व्हाट्सएप",
    image: "rally",
  },
  {
    ...
    excerpt:
      "परिचय से लेकर शिकायत पोर्टल तक — एक भरोसेमंद वेबसाइट के ज़रूरी सेक्शन।",
    date: "24 जुलाई 2026",
    category: "वेबसाइट",
    image: "panchayat",
  },
  {
    ...
    excerpt: "90 दिन का कंटेंट प्लान जो आपकी पहुँच लगातार बढ़ाता रहे।",
    date: "10 जुलाई 2026",
...
export const faqs = [
  {
    q: "क्या आप छोटे गाँव के उम्मीदवारों के लिए भी काम करते हैं?",
    a: "बिल्कुल। हमारा मुख्य फोकस ही ग्राम पंचायत, पंचायत समिति और जिला परिषद उम्मीदवार हैं।",
  },
  {
  ...
  },
  {
    ...
    a: "हाँ, हम हिंदी सहित मराठी, गुजराती, भोजपुरी और अन्य क्षेत्रीय भाषाओं में कंटेंट बनाते हैं।",
  },
  {
    q: "पैकेज की अवधि कितनी होती है?",
    a: "पैकेज मासिक आधार पर होते हैं, और चुनाव अवधि के अनुसार कस्टमाइज़ भी किए जा सकते हैं।",
  },
];
